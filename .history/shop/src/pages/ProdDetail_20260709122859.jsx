        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-4 mt-4">
              <div className="flex items-center gap-4 border border-base-300 rounded-full px-4 py-2">
  <button
    className="text-xl font-bold text-primary hover:opacity-70"
    onClick={() => setQty((q) => Math.max(1, q - 1))}
  >
    −
  </button>
  <span className="text-primary font-semibold min-w-[20px] text-center">
    {qty}
  </span>
  <button
    className="text-xl font-bold text-primary hover:opacity-70"
